package com.wether.zonalnoe.utils;
...
//    @Value("${sms.login}")
    String SMSC_LOGIN = "Denfal";     // логин клиента
//    @Value("${sms.pass}")
    String SMSC_PASSWORD = "Parol123!";  // пароль
...
/*
		Smsc sd = new Smsc();
		// or
		Smsc sd = new Smsc("login", "d11a345a13f8732e549cede82c4ad6891f578bf5");
